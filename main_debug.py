...
parser.add_argument('--data_root_dir', type=str, default='/mnt/storage/COMET/preprocessed/features/', 
                    help='data directory')
...
parser.add_argument('--split_dir', type=str, default='/home/abbas/CLAM/splits/task_2_tumor_subtyping_50/', 
...
parser.add_argument('--exp_code', type=str, help='experiment code for saving results',default='task_2_tumor_subtyping_CLAM_50')
