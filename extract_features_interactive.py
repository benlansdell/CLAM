...
class Args(object):
    def __init__(self):
        self.data_dir = '/mnt/storage/COMET/preprocessed_test/'
        self.csv_path = '/home/blansdell/CLAM/cometFilteredSubset_test.csv'
        self.feat_dir = '/home/blansdell/CLAM/test_features/'
        self.batch_size = 256
        self.slide_ext = '.svs'
