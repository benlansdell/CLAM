...
#Create features
"""
CUDA_VISIBLE_DEVICES=0 python extract_features_fp.py --data_h5_dir /mnt/storage/COMET/preprocessed_1024_fp_batch2/ --data_slide_dir /mnt/storage/COMET/RAW/batch2 --csv_path /home/blansdell/projects/comet/CLAM/comet_all_slides.csv --feat_dir /mnt/storage/COMET/preprocessed_1024_fp_batch2/features/ --batch_size 512 --slide_ext .svs
"""
