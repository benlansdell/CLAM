...
parser.add_argument('--model_size', type=str, choices=['small', 'big', 'custom'], default='small', help='size of model, does not affect mil. if custom, then it will be inferred from the feature data provided')
