...
def seg_and_patch(source, save_dir, patch_save_dir, mask_save_dir, stitch_save_dir, 
				  ...
				  stitch= False, 
				  patch = False, auto_skip=True, process_list = None, pathologist_annotation_only = False):
...
parser.add_argument('--pathologist_annotation_only', type = bool, default=False, action = 'store_true',
...
if __name__ == '__main__':
	...
	seg_times, patch_times = seg_and_patch(**directories, **parameters,
											...
											pathologst_annotation_only = args.pathologist_annotation_only)
